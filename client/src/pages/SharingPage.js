        ...
        <div className="shared-post mt-8">
          <div className="rate-container bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            ...
            <div className="input-group mt-4">
              ...
              <button
                type="button"
                className="mt-4 w-full inline-block rounded bg-[rebeccapurple] px-4 py-2 text-white font-medium uppercase shadow-md transition duration-150 ease-in-out hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50 dark:bg-yellow-600 dark:hover:bg-yellow-500"
                onClick={() =>{
                  console.log("cliked");
                  setIsConfirm(true)
                } }
